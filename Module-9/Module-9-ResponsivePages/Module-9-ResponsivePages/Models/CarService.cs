namespace Module_9_ResponsivePages.Models
{
    public class CarService : ICarService
    {
        //uygulama genelinde bu servisimizi kullanabilmek için(dependency injection) program.cste bu servisi ekleyeceğiz.
